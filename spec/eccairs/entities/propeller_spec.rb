...
RSpec.describe Eccairs::Entities::Propeller do
  describe "class configuration" do
    ...
    it "has correct xml_tag" do
      expect(described_class.xml_tag).to eq("Propeller")
    end
  ...
  describe "XML generation" do
    it "generates valid XML within a report" do
      ...
      occurrence.add_aircraft do |aircraft|
        aircraft.add_propeller do |entity|
          # Empty entity
        end
      end
    end
      ...
      expect(xml).to include('entityId="29"')
    end
