...
RSpec.describe Eccairs::Entities::AirNavigationService do
  describe "class configuration" do
    ...
    it "has correct xml_tag" do
      expect(described_class.xml_tag).to eq("Air_Navigation_Service")
    end
  ...
  describe "XML generation" do
    it "generates valid XML within a report" do
      ...
      occurrence.add_air_navigation_service do |entity|
        # Empty entity
      end
    end
      
      xml = set.to_xml
      expect(xml).to include("Air_Navigation_Service")
      expect(xml).to include('entityId="10"')
    end
