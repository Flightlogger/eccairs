...
RSpec.describe Eccairs::Entities::FlightCrewMember do
  describe "class configuration" do
    ...
    it "has correct xml_tag" do
      expect(described_class.xml_tag).to eq("Flight_Crew_Member")
    end
    ...
    it "generates valid XML within a report" do
      ...
      set.add_occurrence do |occurrence|
        occurrence.add_aircraft do |aircraft|
          aircraft.add_flight_crew_member do |entity|
            # Empty entity
          end
        end
      end
      ...
      expect(xml).to include('entityId="17"')
    end
