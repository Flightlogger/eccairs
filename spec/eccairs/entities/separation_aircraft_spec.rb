...
RSpec.describe Eccairs::Entities::SeparationAircraft do
  describe "class configuration" do
    ...
    it "has correct xml_tag" do
      expect(described_class.xml_tag).to eq("Separation_Aircraft")
    end
  ...
  describe "XML generation" do
      ...
      set.add_occurrence do |occurrence|
        ...
        occurrence.add_separation do |separation|
          separation.add_separation_aircraft do |sep_aircraft|
            sep_aircraft.add_atm_action("1")
            sep_aircraft.add_a_c_avoiding_action("1")
          end
        end
      end

      xml = set.to_xml
      expect(xml).to include("Separation_Aircraft")
      expect(xml).to include("ATM_Action")
    end
    ...
    it "can have nested separation_traffic_info_type_quality" do
      set = Eccairs::Set.new
      set.add_occurrence do |occurrence|
        occurrence.add_file_number("TEST-001")
        occurrence.add_responsible_entity("1")
