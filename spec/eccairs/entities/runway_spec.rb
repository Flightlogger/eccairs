...
RSpec.describe Eccairs::Entities::Runway do
  describe "class configuration" do
    it "has correct entity_id" do
      expect(described_class.entity_id).to eq("31")
    end
    
    it "has correct xml_tag" do
      expect(described_class.xml_tag).to eq("Runway")
    end
  ...
  describe "XML generation" do
    it "generates valid XML within a report" do
      ...
      occurrence.add_aerodrome_general do |aerodrome|
        aerodrome.add_runway do |entity|
          # Empty entity
        end
      end
    end
      ...
      expect(xml).to include('entityId="31"')
    end
