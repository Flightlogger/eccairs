...
RSpec.describe Eccairs::Attributes::MaintenanceDocs do
  describe "class configuration" do
    it "has correct attribute_id" do
      expect(described_class.attribute_id).to eq("174")
    end

    it "has correct xml_tag" do
      expect(described_class.xml_tag).to eq("Maintenance_Docs")
    end
  ...
  describe "XML generation in aircraft" do
    ...
    it "generates XML with correct structure" do
      ...
      set.add_occurrence do |occurrence|
        occurrence.add_aircraft do |aircraft|
          aircraft.add_maintenance_docs(2)
        end
      end
      ...
      expect(xml).to include("<Maintenance_Docs")
      expect(xml).to include('attributeId="174"')
      expect(xml).to include(">2</Maintenance_Docs>")
    end
  end
end
