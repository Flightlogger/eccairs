...
RSpec.describe Eccairs::Attributes::TotalNumberFatalities do
  describe "class configuration" do
    ...
    it "has correct xml_tag" do
      expect(described_class.xml_tag).to eq("Total_Number_Fatalities")
    end
    ...
    it "generates valid XML within an occurrence" do
      ...
      set.add_occurrence do |occurrence|
        occurrence.add_aircraft do |aircraft|
          aircraft.add_total_number_fatalities(10)
        end
      end

      xml = set.to_xml
      expect(xml).to include("Total_Number_Fatalities")
      expect(xml).to include('attributeId="114"')
    end
