...
RSpec.describe Eccairs::Attributes::MinHorizSepRec do
  describe "class configuration" do
    ...
    it "has correct xml_tag" do
      expect(described_class.xml_tag).to eq("Min_Horiz_Sep_Rec")
    end
    ...
    it "generates valid XML within an occurrence" do
      ...
      set.add_occurrence do |occurrence|
        occurrence.add_separation do |sep|
          sep.add_min_horiz_sep_rec(10.5)
        end
      end

      xml = set.to_xml
      expect(xml).to include("Min_Horiz_Sep_Rec")
      expect(xml).to include('attributeId="579"')
    end
