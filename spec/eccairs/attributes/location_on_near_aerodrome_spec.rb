...
RSpec.describe Eccairs::Attributes::LocationOnNearAerodrome do
  describe "class configuration" do
    ...
    it "has correct xml_tag" do
      expect(described_class.xml_tag).to eq("Location_On_Near_Aerodrome")
    end
    ...
    it "generates valid XML within an occurrence" do
      ...
      set.add_occurrence do |occurrence|
        occurrence.add_aerodrome_general do |aerodrome|
          aerodrome.add_location_on_near_aerodrome("1")
        end
      end

      xml = set.to_xml
      expect(xml).to include("Location_On_Near_Aerodrome")
      expect(xml).to include('attributeId="641"')
    end
