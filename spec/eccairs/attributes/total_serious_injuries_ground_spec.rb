...
RSpec.describe Eccairs::Attributes::TotalSeriousInjuriesGround do
  describe "class configuration" do
    ...
    it "has correct xml_tag" do
      expect(described_class.xml_tag).to eq("Total_Serious_Injuries-Ground")
    end
  ...
  describe "XML generation in occurrence" do
    it "generates valid XML within an occurrence" do
      ...
      set.add_occurrence do |occurrence|
        occurrence.add_total_serious_injuries_ground(10)
      end
