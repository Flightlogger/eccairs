...
RSpec.describe Eccairs::Attributes::LastDeparturePoint do
  describe "class configuration" do
    ...
    it "has correct xml_tag" do
      expect(described_class.xml_tag).to eq("Last_Departure_Point")
    end
    ...
    it "generates valid XML within an occurrence" do
      ...
      set.add_occurrence do |occurrence|
        occurrence.add_aircraft do |aircraft|
          aircraft.add_last_departure_point("1000")
        end
      end

      xml = set.to_xml
      expect(xml).to include("Last_Departure_Point")
      expect(xml).to include('attributeId="167"')
    end
