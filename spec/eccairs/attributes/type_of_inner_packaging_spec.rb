...
RSpec.describe Eccairs::Attributes::TypeOfInnerPackaging do
  describe "class configuration" do
    ...
    it "has correct xml_tag" do
      expect(described_class.xml_tag).to eq("Type_Of_Inner_Packaging")
    end
  ...
  describe "XML generation in occurrence" do
    it "generates valid XML within an occurrence" do
      ...
      xml = set.to_xml
      expect(xml).to include("Type_Of_Inner_Packaging")
      expect(xml).to include('attributeId="1059"')
    end
