...
RSpec.describe Eccairs::Attributes::MilitaryACInvolved do
  describe "class configuration" do
    ...
    it "has correct xml_tag" do
      expect(described_class.xml_tag).to eq("Military_A_C_Involved")
    end
    ...
    it "generates valid XML within an occurrence" do
      ...
      set.add_occurrence do |occurrence|
        occurrence.add_separation do |sep|
          sep.add_military_a_c_involved("1")
        end
      end

      xml = set.to_xml
      expect(xml).to include("Military_A_C_Involved")
      expect(xml).to include('attributeId="574"')
    end
