...
RSpec.describe Eccairs::Attributes::FlightPhase do
  describe "class configuration" do
    ...
    it "has correct xml_tag" do
      expect(described_class.xml_tag).to eq("Flight_Phase")
    end
  ...
  describe "XML generation in occurrence" do
    it "generates valid XML within an occurrence" do
      ...
      xml = set.to_xml
      expect(xml).to include("Flight_Phase")
      expect(xml).to include('attributeId="121"')
    end
