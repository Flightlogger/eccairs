...
RSpec.describe Eccairs::Attributes::TypeOfOuterPackaging do
  describe "class configuration" do
    ...
    it "has correct xml_tag" do
      expect(described_class.xml_tag).to eq("Type_Of_Outer_Packaging")
    end
  ...
  describe "XML generation in occurrence" do
    it "generates valid XML within an occurrence" do
      ...
      xml = set.to_xml
      expect(xml).to include("Type_Of_Outer_Packaging")
      expect(xml).to include('attributeId="1056"')
    end
