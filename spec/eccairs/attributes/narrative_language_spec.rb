...
RSpec.describe Eccairs::Attributes::NarrativeLanguage do
  describe "class configuration" do
    ...
    it "has correct xml_tag" do
      expect(described_class.xml_tag).to eq("Narrative_Language")
    end
  ...
  describe "XML generation in occurrence" do
    it "generates valid XML within an occurrence" do
      ...
      xml = set.to_xml
      expect(xml).to include("Narrative_Language")
      expect(xml).to include('attributeId="424"')
    end
