...
RSpec.describe Eccairs::Attributes::SubsidiaryRisk do
  describe "class configuration" do
    ...
    it "has correct xml_tag" do
      expect(described_class.xml_tag).to eq("Subsidiary_Risk")
    end
  ...
  describe "XML generation in occurrence" do
    it "generates valid XML within an occurrence" do
      ...
      xml = set.to_xml
      expect(xml).to include("Subsidiary_Risk")
      expect(xml).to include('attributeId="1055"')
    end
