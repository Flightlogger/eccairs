...
RSpec.describe Eccairs::Attributes::AirWaybillConsignmentTrackingNumber do
  describe "class configuration" do
    ...
    it "has correct xml_tag" do
      expect(described_class.xml_tag).to eq("Air_Waybill_Consignment_Tracking_Number")
    end
    ...
    it "generates valid XML within an occurrence" do
      ...
      set.add_occurrence do |occurrence|
        occurrence.add_dangerous_goods do |dg|
          dg.add_air_waybill_consignment_tracking_number("test value")
        end
      end

      xml = set.to_xml
      expect(xml).to include("Air_Waybill_Consignment_Tracking_Number")
      expect(xml).to include('attributeId="1052"')
    end
