...
RSpec.describe Eccairs::Attributes::PilotAdvisedOfBirds do
  describe "class configuration" do
    ...
    it "has correct xml_tag" do
      expect(described_class.xml_tag).to eq("Pilot_Advised_Of_Birds")
    end
    ...
    it "generates valid XML within an occurrence" do
      ...
      set.add_occurrence do |occurrence|
        occurrence.add_aircraft do |aircraft|
          aircraft.add_pilot_advised_of_birds("1")
        end
      end

      xml = set.to_xml
      expect(xml).to include("Pilot_Advised_Of_Birds")
      expect(xml).to include('attributeId="649"')
    end
