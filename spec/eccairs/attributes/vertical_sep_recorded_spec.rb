...
RSpec.describe Eccairs::Attributes::VerticalSepRecorded do
  describe "class configuration" do
    ...
    it "has correct xml_tag" do
      expect(described_class.xml_tag).to eq("Vertical_Sep_Recorded")
    end
    ...
    it "generates valid XML within an occurrence" do
      ...
      set.add_occurrence do |occurrence|
        occurrence.add_separation do |sep|
          sep.add_vertical_sep_recorded(10.5)
        end
      end

      xml = set.to_xml
      expect(xml).to include("Vertical_Sep_Recorded")
      expect(xml).to include('attributeId="585"')
    end
