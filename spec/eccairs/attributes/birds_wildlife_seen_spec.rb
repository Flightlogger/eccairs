...
RSpec.describe Eccairs::Attributes::BirdsWildlifeSeen do
  describe "class configuration" do
    ...
    it "has correct xml_tag" do
      expect(described_class.xml_tag).to eq("Birds_Wildlife_Seen")
    end
  ...
  describe "XML generation in occurrence" do
    it "generates valid XML within an occurrence" do
      ...
      xml = set.to_xml
      expect(xml).to include("Birds_Wildlife_Seen")
      expect(xml).to include('attributeId="646"')
    end
