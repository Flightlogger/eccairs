...
RSpec.describe Eccairs::Attributes::RiskLevel do
  describe "class configuration" do
    ...
    it "has correct xml_tag" do
      expect(described_class.xml_tag).to eq("Risk_Level")
    end
  ...
  describe "XML generation in occurrence" do
    it "generates valid XML within an occurrence" do
      ...
      xml = set.to_xml
      expect(xml).to include("Risk_Level")
      expect(xml).to include('attributeId="940"')
    end
