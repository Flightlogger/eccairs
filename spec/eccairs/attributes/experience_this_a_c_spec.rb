...
RSpec.describe Eccairs::Attributes::ExperienceThisAC do
  describe "class configuration" do
    ...
    it "has correct xml_tag" do
      expect(described_class.xml_tag).to eq("Experience_This_A_C")
    end
      ...
      set.add_occurrence do |occurrence|
        occurrence.add_aircraft do |aircraft|
          aircraft.add_flight_crew_member do |crew|
            crew.add_experience_this_a_c(10.5)
          end
        end
      end

      xml = set.to_xml
      expect(xml).to include("Experience_This_A_C")
      expect(xml).to include('attributeId="411"')
    end
