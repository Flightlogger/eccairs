...
RSpec.describe Eccairs::Attributes::Operator do
  describe "class configuration" do
    ...
    it "has correct xml_tag" do
      expect(described_class.xml_tag).to eq("Operator")
    end
  ...
  describe "initialization" do
    it "creates an instance with a value" do
      instance = described_class.new("20000")
      expect(instance.value).to eq("20000")
    end
  end
    ...
    it "generates valid XML within an occurrence" do
      ...
      set.add_occurrence do |occurrence|
        occurrence.add_aircraft do |aircraft|
          aircraft.add_operator("20000")
        end
      end

      xml = set.to_xml
      expect(xml).to include("Operator")
      expect(xml).to include('attributeId="215"')
    end
