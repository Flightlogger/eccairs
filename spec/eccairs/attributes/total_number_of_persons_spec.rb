...
RSpec.describe Eccairs::Attributes::TotalNumberOfPersons do
  describe "class configuration" do
    ...
    it "has correct xml_tag" do
      expect(described_class.xml_tag).to eq("Total_Number_Of_Persons")
    end
    ...
    it "generates valid XML within an occurrence" do
      ...
      set.add_occurrence do |occurrence|
        occurrence.add_aircraft do |aircraft|
          aircraft.add_total_number_of_persons(10)
        end
      end

      xml = set.to_xml
      expect(xml).to include("Total_Number_Of_Persons")
      expect(xml).to include('attributeId="152"')
    end
