...
RSpec.describe Eccairs::Attributes::VehicleControlled do
  describe "class configuration" do
    ...
    it "has correct xml_tag" do
      expect(described_class.xml_tag).to eq("Vehicle_Controlled")
    end
    ...
    it "generates valid XML within an occurrence" do
      ...
      set.add_occurrence do |occurrence|
        occurrence.add_aerodrome_general do |aerodrome|
          aerodrome.add_vehicle do |vehicle|
            vehicle.add_vehicle_controlled("1")
          end
        end
      end

      xml = set.to_xml
      expect(xml).to include("Vehicle_Controlled")
      expect(xml).to include('attributeId="743"')
    end
