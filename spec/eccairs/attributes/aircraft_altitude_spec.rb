...
RSpec.describe Eccairs::Attributes::AircraftAltitude do
  describe "class configuration" do
    ...
    it "has correct xml_tag" do
      expect(described_class.xml_tag).to eq("Aircraft_Altitude")
    end
    ...
    it "generates valid XML within an occurrence" do
      ...
      set.add_occurrence do |occurrence|
        occurrence.add_aircraft do |aircraft|
          aircraft.add_aircraft_altitude(10.5)
        end
      end

      xml = set.to_xml
      expect(xml).to include("Aircraft_Altitude")
      expect(xml).to include('attributeId="22"')
    end
