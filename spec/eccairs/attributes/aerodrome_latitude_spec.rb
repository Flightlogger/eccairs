...
RSpec.describe Eccairs::Attributes::AerodromeLatitude do
  describe "class configuration" do
    ...
    it "has correct xml_tag" do
      expect(described_class.xml_tag).to eq("Aerodrome_Latitude")
    end
    ...
    it "generates valid XML within an occurrence" do
      ...
      set.add_occurrence do |occurrence|
        occurrence.add_aerodrome_general do |aerodrome|
          aerodrome.add_aerodrome_latitude(10.5)
        end
      end

      xml = set.to_xml
      expect(xml).to include("Aerodrome_Latitude")
      expect(xml).to include('attributeId="1"')
    end
