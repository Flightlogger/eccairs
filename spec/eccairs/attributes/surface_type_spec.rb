...
RSpec.describe Eccairs::Attributes::SurfaceType do
  describe "class configuration" do
    ...
    it "has correct xml_tag" do
      expect(described_class.xml_tag).to eq("Surface_Type")
    end
  ...
  describe "XML generation in occurrence" do
    it "generates valid XML within an occurrence" do
      ...
      xml = set.to_xml
      expect(xml).to include("Surface_Type")
      expect(xml).to include('attributeId="509"')
    end
