...
RSpec.describe Eccairs::Attributes::WxConditions do
  describe "class configuration" do
    ...
    it "has correct xml_tag" do
      expect(described_class.xml_tag).to eq("Wx_Conditions")
    end
  ...
  describe "XML generation in occurrence" do
    it "generates valid XML within an occurrence" do
      ...
      xml = set.to_xml
      expect(xml).to include("Wx_Conditions")
      expect(xml).to include('attributeId="127"')
    end
