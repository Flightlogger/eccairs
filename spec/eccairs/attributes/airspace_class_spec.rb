...
RSpec.describe Eccairs::Attributes::AirspaceClass do
  describe "class configuration" do
    ...
    it "has correct xml_tag" do
      expect(described_class.xml_tag).to eq("Airspace_Class")
    end
    ...
    it "generates valid XML within an occurrence" do
      ...
      set.add_occurrence do |occurrence|
        occurrence.add_air_space do |as|
          as.add_airspace_class("1")
        end
      end

      xml = set.to_xml
      expect(xml).to include("Airspace_Class")
      expect(xml).to include('attributeId="13"')
    end
