...
RSpec.describe Eccairs::Attributes::ServicesProvided do
  describe "class configuration" do
    ...
    it "has correct xml_tag" do
      expect(described_class.xml_tag).to eq("Services_Provided")
    end
  ...
  describe "XML generation in occurrence" do
    it "generates valid XML within an occurrence" do
      ...
      xml = set.to_xml
      expect(xml).to include("Services_Provided")
      expect(xml).to include('attributeId="527"')
    end
