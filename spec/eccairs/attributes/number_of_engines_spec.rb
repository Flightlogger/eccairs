...
RSpec.describe Eccairs::Attributes::NumberOfEngines do
  describe "class configuration" do
    ...
    it "has correct xml_tag" do
      expect(described_class.xml_tag).to eq("Number_Of_Engines")
    end
  ...
  describe "XML generation in occurrence" do
    it "generates valid XML within an occurrence" do
      ...
      xml = set.to_xml
      expect(xml).to include("Number_Of_Engines")
      expect(xml).to include('attributeId="209"')
    end
