...
RSpec.describe Eccairs::Attributes::EstVertSeparation do
  describe "class configuration" do
    ...
    it "has correct xml_tag" do
      expect(described_class.xml_tag).to eq("Est_Vert_Separation")
    end
    ...
    it "generates valid XML within an occurrence" do
      ...
      set.add_occurrence do |occurrence|
        occurrence.add_separation do |sep|
          sep.add_est_vert_separation(10.5)
        end
      end

      xml = set.to_xml
      expect(xml).to include("Est_Vert_Separation")
      expect(xml).to include('attributeId="581"')
    end
