...
RSpec.describe "Eccairs::Occurrence::Entities::AerodromeGeneral::Runway" do
  describe "ECCAIRS set validation" do
    it "generates a valid ECCAIRS set with nested Runway entity under Aerodrome_General" do
      ...
      set.add_entity(Eccairs::Occurrence::Entities::AerodromeGeneral::Runway::Attributes::RunwayIdentifier.new("04L"))
      set.add_entity(Eccairs::Occurrence::Entities::AerodromeGeneral::Runway::Attributes::SurfaceType.new(1))
