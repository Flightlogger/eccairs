...
RSpec.describe Eccairs::Occurrence::Entities::AerodromeGeneral::Entities::Vehicle::Attributes::TypeOfVehicle do
  ...
  describe "ECCAIRS set validation" do
    it "generates a valid ECCAIRS set with type_of_vehicle" do
      set = Eccairs.set
