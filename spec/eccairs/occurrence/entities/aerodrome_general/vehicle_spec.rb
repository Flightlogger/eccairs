...
RSpec.describe "Eccairs::Occurrence::Entities::AerodromeGeneral::Vehicle" do
  describe "ECCAIRS report validation" do
    it "generates a valid ECCAIRS report with nested Vehicle entity under Aerodrome_General" do
      ...
      occurrence.add_entity(Eccairs::Occurrence::Entities::AerodromeGeneral::Vehicle::Attributes::TypeOfVehicle.new(1))
      occurrence.add_entity(Eccairs::Occurrence::Entities::AerodromeGeneral::Vehicle::Attributes::VehicleControlled.new(1))
