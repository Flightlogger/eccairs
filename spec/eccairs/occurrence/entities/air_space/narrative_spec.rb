...
RSpec.describe "Eccairs::Occurrence::Entities::AirSpace::Narrative" do
  describe "ECCAIRS report validation" do
    it "generates a valid ECCAIRS report with nested Narrative entity under Air Space" do
      ...
      occurrence.add_entity(Eccairs::Occurrence::Entities::AirSpace::Narrative::Attributes::NarrativeLanguage.new(1))
      occurrence.add_entity(Eccairs::Occurrence::Entities::AirSpace::Narrative::Attributes::NarrativeText.new("Test narrative text"))
