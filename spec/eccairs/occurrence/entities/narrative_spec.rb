...
RSpec.describe Eccairs::Occurrence::Entities::Narrative do
  ...
  describe "ECCAIRS set validation" do
    it "generates a valid ECCAIRS set with narrative entity" do
      ...
      set.add_entity(Eccairs::Occurrence::Entities::Narrative::Attributes::NarrativeText.new("Test narrative"))
