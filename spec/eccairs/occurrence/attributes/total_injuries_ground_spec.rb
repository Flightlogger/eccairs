...
RSpec.describe Eccairs::Occurrence::Attributes::TotalInjuriesGround do
  ...
  describe ".attribute_id" do
    it "returns attribute ID of 463" do
      expect(described_class.attribute_id).to eq("463")
    end
  end
  ...
  describe "#build_xml" do
    it "generates valid XML with value" do
      ...
      expect(xml).to include("Total_Injuries-Ground")
      expect(xml).to include('attributeId="463"')
    end
    ...
    it "does not generate XML when value is nil" do
      ...
      expect(xml).not_to include("Total_Injuries-Ground")
    end
  end
