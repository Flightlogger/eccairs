...
RSpec.describe Eccairs::Occurrence::Attributes::EffectOnAtmService do
  describe "#initialize" do
    ...
    it "initializes with provided value" do
          entity = described_class.new(4)
          expect(entity.value).to eq(4)
  end
end

describe ".attribute_id" do
  it "returns attribute ID of 436" do
...
describe "#build_xml" do
  ...
  it "does not generate XML when value is nil" do
    ...
    expect(xml).not_to include("Effect_On_ATM_Service")
  end
end

describe "validation" do
  it "accepts valid values" do
            expect { described_class.new(4) }.not_to raise_error
