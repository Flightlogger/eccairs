...
RSpec.describe Eccairs::Occurrence::Attributes::GroundSeverityApplied do
  ...
  describe ".attribute_id" do
    it "returns attribute ID of 1073" do
  ...
  describe "#build_xml" do
    ...
    it "does not generate XML when value is nil" do
      ...
      expect(xml).not_to include("Ground_Severity_Applied")
    end
  end
