...
RSpec.describe Eccairs::Occurrence::Attributes::GroundSeverity do
...
describe ".attribute_id" do
  it "returns attribute ID of 1074" do
    expect(described_class.attribute_id).to eq("1074")
  end
end
...
describe "#build_xml" do
  it "generates valid XML with value" do
    ...
    expect(xml).to include("Ground_Severity")
    expect(xml).to include('attributeId="1074"')
  end
  ...
  it "does not generate XML when value is nil" do
    ...
    expect(xml).not_to include("Ground_Severity")
  end
end
