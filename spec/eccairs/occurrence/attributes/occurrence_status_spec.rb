...
RSpec.describe Eccairs::Occurrence::Attributes::OccurrenceStatus do
  describe "#initialize" do
    ...
    it "initializes with provided value" do
      entity = described_class.new(5)
      expect(entity.value).to eq(5)
    end
  end

  describe ".attribute_id" do
    it "returns attribute ID of 455" do
      expect(described_class.attribute_id).to eq("455")
    end
  end
  ...
  describe "#build_xml" do
    it "generates valid XML with value" do
      ...
      expect(xml).to include("Occurrence_Status")
      expect(xml).to include('attributeId="455"')
    end
    ...
    it "does not generate XML when value is nil" do
      ...
      expect(xml).not_to include("Occurrence_Status")
    end
  end

  describe "validation" do
    it "accepts valid values" do
      expect { described_class.new(5) }.not_to raise_error
