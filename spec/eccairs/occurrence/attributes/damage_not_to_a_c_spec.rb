...
RSpec.describe Eccairs::Occurrence::Attributes::DamageNotToAC do
  describe "#initialize" do
    ...
    it "initializes with provided value" do
          entity = described_class.new(97)
          expect(entity.value).to eq(97)
  end
end

describe ".attribute_id" do
  it "returns attribute ID of 448" do
    expect(described_class.attribute_id).to eq("448")
  end
end
...
describe "#build_xml" do
  it "generates valid XML with value" do
    ...
    expect(xml).to include("Damage_Not_To_A_C")
    expect(xml).to include('attributeId="448"')
  end
  ...
  it "does not generate XML when value is nil" do
    ...
    expect(xml).not_to include("Damage_Not_To_A_C")
  end
end

describe "validation" do
  it "accepts valid values" do
            expect { described_class.new(97) }.not_to raise_error
