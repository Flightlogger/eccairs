...
RSpec.describe Eccairs::Occurrence::Attributes::ObjectDamaged do
...
describe ".attribute_id" do
  it "returns attribute ID of 640" do
    expect(described_class.attribute_id).to eq("640")
  end
end
...
describe "#build_xml" do
  it "generates valid XML with value" do
    ...
    expect(xml).to include("Object_Damaged")
    expect(xml).to include('attributeId="640"')
  end
  ...
  it "does not generate XML when value is nil" do
    ...
    expect(xml).not_to include("Object_Damaged")
  end
end
...
describe "validation" do
  it "accepts valid values" do
            ...
            expect { described_class.new(6) }.not_to raise_error
