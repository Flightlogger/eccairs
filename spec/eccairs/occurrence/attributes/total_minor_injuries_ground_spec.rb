...
RSpec.describe Eccairs::Occurrence::Attributes::TotalMinorInjuriesGround do
  ...
  describe ".attribute_id" do
    it "returns attribute ID of 469" do
  ...
  describe "#build_xml" do
    ...
    it "does not generate XML when value is nil" do
      ...
      expect(xml).not_to include("Total_Minor_Injuries-Ground")
    end
  end
