...
RSpec.describe Eccairs::Occurrence::Attributes::OverallSeverityApplied do
  ...
  describe ".attribute_id" do
    it "returns attribute ID of 1076" do
  ...
  describe "#build_xml" do
    ...
    it "does not generate XML when value is nil" do
      ...
      expect(xml).not_to include("Overall_Severity_Applied")
    end
  end
