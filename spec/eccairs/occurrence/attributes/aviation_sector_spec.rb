...
RSpec.describe Eccairs::Occurrence::Attributes::AviationSector do
...
describe ".attribute_id" do
  it "returns attribute ID of 1088" do
    expect(described_class.attribute_id).to eq("1088")
  end
end
...
describe "#build_xml" do
  it "generates valid XML with value" do
    ...
    expect(xml).to include("Aviation_Sector")
    expect(xml).to include('attributeId="1088"')
  end
  ...
  it "does not generate XML when value is nil" do
    ...
    expect(xml).not_to include("Aviation_Sector")
  end
end
