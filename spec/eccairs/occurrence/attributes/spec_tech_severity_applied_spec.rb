...
RSpec.describe Eccairs::Occurrence::Attributes::SpecTechSeverityApplied do
...
describe ".attribute_id" do
  it "returns attribute ID of 1079" do
...
describe "#build_xml" do
  ...
  it "does not generate XML when value is nil" do
    ...
    expect(xml).not_to include("Spec_Tech_Severity_Applied")
  end
end
