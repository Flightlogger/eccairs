...
RSpec.describe Eccairs::Occurrence::Attributes::SpeedMeasuredAt do
  ...
  describe ".attribute_id" do
    it "returns attribute ID of 275" do
      expect(described_class.attribute_id).to eq("275")
    end
  end
  ...
  describe "#build_xml" do
    it "generates valid XML with value" do
      ...
      expect(xml).to include("Speed_Measured_At")
      expect(xml).to include('attributeId="275"')
    end
    ...
    it "does not generate XML when value is nil" do
      ...
      expect(xml).not_to include("Speed_Measured_At")
    end
  end
  ...
  describe "validation" do
    it "accepts valid values" do
      ...
      expect { described_class.new(99) }.not_to raise_error
    end
