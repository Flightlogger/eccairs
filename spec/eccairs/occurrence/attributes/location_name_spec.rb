...
RSpec.describe Eccairs::Occurrence::Attributes::LocationName do
  ...
  describe ".attribute_id" do
    it "returns attribute ID of 440" do
      expect(described_class.attribute_id).to eq("440")
    end
  end
  ...
  describe "#build_xml" do
    it "generates valid XML with value" do
      ...
      expect(xml).to include("Location_Name")
      expect(xml).to include('attributeId="440"')
    end
    ...
    it "does not generate XML when value is nil" do
      ...
      expect(xml).not_to include("Location_Name")
    end
  end
  ...
  describe "ECCAIRS set validation" do
    it "generates a valid ECCAIRS set" do
      set = Eccairs.set
      entity = described_class.new("Test Location")
