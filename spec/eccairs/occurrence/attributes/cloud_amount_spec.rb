...
RSpec.describe Eccairs::Occurrence::Attributes::CloudAmount do
...
describe ".attribute_id" do
  it "returns attribute ID of 266" do
    expect(described_class.attribute_id).to eq("266")
  end
end
...
describe "#build_xml" do
  it "generates valid XML with value" do
    ...
    expect(xml).to include("Cloud_Amount")
    expect(xml).to include('attributeId="266"')
  end
  ...
  it "does not generate XML when value is nil" do
    ...
    expect(xml).not_to include("Cloud_Amount")
  end
end
