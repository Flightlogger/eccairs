...
RSpec.describe Eccairs::Occurrence::Attributes::SpecTechRepeatability do
  ...
  describe ".attribute_id" do
    it "returns attribute ID of 1081" do
  ...
  describe "#build_xml" do
    ...
    it "does not generate XML when value is nil" do
      ...
      expect(xml).not_to include("Spec_Tech_Repeatability")
    end
  end
