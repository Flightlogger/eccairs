...
RSpec.describe Eccairs::Occurrence::Attributes::OverallSeverity do
...
describe ".attribute_id" do
  it "returns attribute ID of 1077" do
    expect(described_class.attribute_id).to eq("1077")
  end
end
...
describe "#build_xml" do
  it "generates valid XML with value" do
    ...
    expect(xml).to include("Overall_Severity")
    expect(xml).to include('attributeId="1077"')
  end
  ...
  it "does not generate XML when value is nil" do
    ...
    expect(xml).not_to include("Overall_Severity")
  end
end
