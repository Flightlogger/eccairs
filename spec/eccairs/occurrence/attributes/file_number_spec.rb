...
RSpec.describe Eccairs::Occurrence::Attributes::FileNumber do
...
describe ".attribute_id" do
  it "returns attribute ID of 452" do
...
describe "#build_xml" do
  ...
  it "does not generate XML when value is nil" do
    ...
    expect(xml).not_to include("File_Number")
  end
end
...
describe "ECCAIRS report validation" do
  it "generates a valid ECCAIRS report" do
    ...
    entity = described_class.new("TEST-001")
