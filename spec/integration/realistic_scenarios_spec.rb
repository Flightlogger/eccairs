...
RSpec.describe "Realistic ECCAIRS XML Generation Scenarios" do
  describe "Scenario 1: Bird Strike During Takeoff" do
    it "generates a valid ECCAIRS report for a bird strike incident" do
      ...
      occurrence.add_entity(Eccairs::Occurrence::Attributes::Headline.new("Bird strike during takeoff roll"))
      occurrence.add_entity(Eccairs::Occurrence::Attributes::LocationName.new("John F. Kennedy International Airport"))
      ...
      occurrence.add_entity(Eccairs::Occurrence::Attributes::LocalDate.new("2024-03-15"))
      occurrence.add_entity(Eccairs::Occurrence::Attributes::LocalTime.new("10:30:00"))
      ...
      occurrence.add_entity(Eccairs::Occurrence::Entities::AerodromeGeneral::Attributes::AerodromeLatitude.new(40.6413))
      occurrence.add_entity(Eccairs::Occurrence::Entities::AerodromeGeneral::Attributes::AerodromeLongitude.new(-73.7781))
      occurrence.add_entity(Eccairs::Occurrence::Entities::AerodromeGeneral::Attributes::ElevationAboveMsl.new(13.0))
      occurrence.add_entity(Eccairs::Occurrence::Entities::AerodromeGeneral::Attributes::AerodromeType.new(1))

      # Runway information
      occurrence.add_entity(Eccairs::Occurrence::Entities::AerodromeGeneral::Runway::Attributes::RunwayIdentifier.new("04R"))
      ...
      occurrence.add_entity(Eccairs::Occurrence::Entities::Aircraft::Attributes::MaximumToMass.new(79000))
      ...
      # Bird strike details
      occurrence.add_entity(Eccairs::Occurrence::Entities::Aircraft::Attributes::BirdsWildlifeSeen.new(1))
      occurrence.add_entity(Eccairs::Occurrence::Entities::Aircraft::Attributes::BirdsWildlifeStruck.new(1))
      occurrence.add_entity(Eccairs::Occurrence::Entities::Aircraft::Attributes::BirdSize.new(1))
  ...
  describe "Scenario 2: Runway Incursion with ATC Involvement" do
    it "generates a valid ECCAIRS report for a runway incursion" do
      ...
      # Basic occurrence information
      occurrence.add_entity(Eccairs::Occurrence::Attributes::Headline.new("Runway incursion - vehicle crossed active runway"))
      occurrence.add_entity(Eccairs::Occurrence::Attributes::LocationName.new("London Heathrow Airport"))
      occurrence.add_entity(Eccairs::Occurrence::Attributes::UtcDate.new("2024-06-20"))
      occurrence.add_entity(Eccairs::Occurrence::Attributes::UtcTime.new("09:15:00"))
      occurrence.add_entity(Eccairs::Occurrence::Attributes::LocalDate.new("2024-06-20"))
      occurrence.add_entity(Eccairs::Occurrence::Attributes::LocalTime.new("10:15:00"))
      occurrence.add_entity(Eccairs::Occurrence::Attributes::OccurrenceCategory.new(1))

      # Weather conditions - good visibility
      occurrence.add_entity(Eccairs::Occurrence::Attributes::WxConditions.new(1)) # VMC
      occurrence.add_entity(Eccairs::Occurrence::Attributes::Visibility.new(10000))
      occurrence.add_entity(Eccairs::Occurrence::Attributes::AirTemperature.new(22.0))
      occurrence.add_entity(Eccairs::Occurrence::Attributes::WindSpeed.new(5.0))
      occurrence.add_entity(Eccairs::Occurrence::Attributes::WindDirection.new(90))
      ...
      occurrence.add_entity(Eccairs::Occurrence::Entities::AerodromeGeneral::Attributes::AerodromeType.new(1))
      occurrence.add_entity(Eccairs::Occurrence::Entities::AerodromeGeneral::Attributes::LocationOnNearAerodrome.new(1)) # Runway

      # Runway information
      occurrence.add_entity(Eccairs::Occurrence::Entities::AerodromeGeneral::Runway::Attributes::RunwayIdentifier.new("27L"))
      ...
      occurrence.add_entity(Eccairs::Occurrence::Entities::Aircraft::Attributes::FlightPhase.new(6)) # Approach
      ...
      occurrence.add_entity(Eccairs::Occurrence::Entities::AirNavigationService::Sector::Attributes::SectorName.new("Tower"))
      occurrence.add_entity(Eccairs::Occurrence::Entities::AirNavigationService::Sector::Attributes::ServicesProvided.new(2000000))
  ...
  describe "Scenario 3: Engine Failure During Cruise" do
    it "generates a valid ECCAIRS report for an engine failure" do
      ...
      # Basic occurrence information
      occurrence.add_entity(Eccairs::Occurrence::Attributes::Headline.new("Engine failure during cruise - successful emergency landing"))
      occurrence.add_entity(Eccairs::Occurrence::Attributes::LocationName.new("Over North Atlantic"))
      occurrence.add_entity(Eccairs::Occurrence::Attributes::UtcDate.new("2024-08-10"))
      occurrence.add_entity(Eccairs::Occurrence::Attributes::UtcTime.new("16:45:00"))
      occurrence.add_entity(Eccairs::Occurrence::Attributes::LatitudeOfOcc.new(45.5))
      occurrence.add_entity(Eccairs::Occurrence::Attributes::LongitudeOfOcc.new(-30.2))
      occurrence.add_entity(Eccairs::Occurrence::Attributes::OccurrenceCategory.new(1))

      # Weather conditions
      occurrence.add_entity(Eccairs::Occurrence::Attributes::WxConditions.new(2)) # IMC
      occurrence.add_entity(Eccairs::Occurrence::Attributes::AirTemperature.new(-40.0))
      occurrence.add_entity(Eccairs::Occurrence::Attributes::WindSpeed.new(45.0))
      occurrence.add_entity(Eccairs::Occurrence::Attributes::WindDirection.new(270))

      # Aircraft information
      occurrence.add_entity(Eccairs::Occurrence::Entities::Aircraft::Attributes::AircraftCategory.new(1))
      occurrence.add_entity(Eccairs::Occurrence::Entities::Aircraft::Attributes::AircraftRegistration.new("N98765"))
      occurrence.add_entity(Eccairs::Occurrence::Entities::Aircraft::Attributes::SerialNumber.new("98765"))
      occurrence.add_entity(Eccairs::Occurrence::Entities::Aircraft::Attributes::YearBuilt.new(2015))
      occurrence.add_entity(Eccairs::Occurrence::Entities::Aircraft::Attributes::MaximumToMass.new(250000))
      occurrence.add_entity(Eccairs::Occurrence::Entities::Aircraft::Attributes::NumberOfEngines.new(2))
      occurrence.add_entity(Eccairs::Occurrence::Entities::Aircraft::Attributes::FlightPhase.new(5)) # Cruise
      occurrence.add_entity(Eccairs::Occurrence::Entities::Aircraft::Attributes::TotalNumberOfPersons.new(189))

      # Engine information
      occurrence.add_entity(Eccairs::Occurrence::Entities::Aircraft::Engine::Attributes::EnginePosition.new(2)) # Right
      occurrence.add_entity(Eccairs::Occurrence::Entities::Aircraft::Engine::Attributes::EngineSerialNumber.new("ENG-54321"))
      occurrence.add_entity(Eccairs::Occurrence::Entities::Aircraft::Engine::Attributes::HazardEngEffect.new(1))
